...
class Calculator
  ...
  def self.amortization_table(loan, menu)
    ...
    term.times do
      ...
      line = format('%2d $%-8.2f  $%-9.2f $%-9.2f $%-9.2f $%.2f', month, start_principal.round(2), principal_payment.round(2),
                    interest_payment.round(2), payment.round(2), principal.round(2))
